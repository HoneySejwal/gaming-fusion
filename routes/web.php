<?php
    ...
    */
    ...
    Route::get('sync/{zJhPuadIoQuyelTKLEYkyGafCEAPNDuX}',[CurrencyController::class,'sync'])->name('sync');
...
// Frontend Routes
    ...
    Route::view('/cat-list/{slug}', 'frontend.pages.cat-list')->name('cat-list');
...
Route::get('trainingdelete/{id}', [CartController::class, 'trainingdelete'])->name('trainingdelete');
...
// User section start
    ...
    Route::view('database','frontend.pages.database')->name('database');
