...
@section('title','Towa-Xports || Game List')

@section('main-content')

    <main>
        <!-- GT Breadcrunb Section Start -->
        <div class="gt-breadcrumb-wrapper bg-cover" style="background-image: url('assets/img/breadcrumb.png');">
     ...
     <button type="submit" class="gt-theme-btn">
      <i class="far fa-shopping-cart"></i> Add To Cart
            ...
            <h2 class="accordion-header d-md-none" id="headingtwo">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsetwo" aria-expanded="true" aria-controls="collapsetwo">Home</button>
            </h2>
